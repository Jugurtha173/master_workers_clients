...
BIN1 = client
SRC1 = client.c master_client.c myassert.c mybiblio.c
OBJ1 = $(subst .c,.o,$(SRC1))
DFILES1 = $(subst .c,.d,$(SRC1))

BIN2 = master
SRC2 = master.c master_client.c master_worker.c myassert.c mybiblio.c
OBJ2 = $(subst .c,.o,$(SRC2))
DFILES2 = $(subst .c,.d,$(SRC2))

BIN3 = worker
SRC3 = worker.c master_worker.c myassert.c mybiblio.c
OBJ3 = $(subst .c,.o,$(SRC3))
